...
const giftUpdate=(e)=>{
  ...
  e.preventDefault()
   ...
   datos[index].tipo = document.querySelector("#Modal").value
   datos[index].tiempo = document.querySelector("#Modal").value
   datos[index].precio = document.querySelector("#Modal").value
   datos[index].imagen = document.querySelector("#Modal").value;
