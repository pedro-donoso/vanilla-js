...
const giftUpdate=(e)=>{
  ...
  e.preventDefault()
   ...
   datos[index].tiempo = document.querySelector("#tipoModal").value
   datos[index].precio = document.querySelector("#tipoModal").value
   datos[index].imagen = document.querySelector("#tipoModal").value;
