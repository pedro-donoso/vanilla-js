...
const giftUpdate=(e)=>{
  ...
  e.preventDefault()
   ...
   datos[index].tipo = document.querySelector("#giftModal").value
   datos[index].tiempo = document.querySelector("#giftModal").value
   datos[index].precio = document.querySelector("#giftModal").value
   datos[index].imagen = document.querySelector("#giftModal").value;
