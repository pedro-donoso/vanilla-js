...
window.mostrarModal=(id)=>{
  ...
  let index = datos.findIndex((item) => item.id == id);
   ...
   document.querySelector("#giftModal").value=datos
   document.querySelector("#tipoModal").value=datos
   document.querySelector("#tiempoModal").value=datos
   document.querySelector("#precioModal").value=datos
   document.querySelector("#imagenModal").value=datos
