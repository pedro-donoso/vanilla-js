...
window.mostrarModal=(id)=>{
  ...
  let index = datos.findIndex((item) => item.id == id);
   ...
   document.querySelector("#giftModal").value=datos[i]
   document.querySelector("#tipoModal").value=datos[i]
   document.querySelector("#tiempoModal").value=datos[i]
   document.querySelector("#precioModal").value=datos[i]
   document.querySelector("#imagenModal").value=datos[i]
