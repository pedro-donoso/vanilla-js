...
window.mostrarModal=(id)=>{
  ...
  let index = datos.findIndex((item) => item.id == id);
   ...
   document.querySelector("#giftModal").value;
   document.querySelector("#tipoModal").value;
   document.querySelector("#tiempoModal").value;
   document.querySelector("#precioModal").value;
   document.querySelector("#imagenModal").value;
